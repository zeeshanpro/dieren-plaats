...
<head>
	...
	<title>Message From Dplatts</title>
</head>
<body style="margin:0;padding:0;">
	<div style="background:#f72442;max-height: 60px;display: flex;justify-content: center;">
		<a href="<?php echo e(url('')); ?>" target="_blank" style="display:flex;text-decoration: none;">
	 <img src="<?php echo e(url('/public/front_assets/images/logo-small.png')); ?>" style="padding-left: 20px;" />
	...
	<div style="padding:25px;background: #f5f5f5;padding-bottom: 100px;">
	<?php $__env->startSection('container'); ?>
    <?php echo $__env->yieldSection(); ?>
    </div>

    <!-- 	<div style="background:#f72442;padding:25px;color: white;">
    		<div style="font-size: 25px;font-weight: bold;padding-bottom: 10px;">
    		Disclaimer:
    	</div>
...
</html><?php /**PATH /home/dierenlara/domains/dieren-plaats.nl/public_html/resources/views/front/layout/emailLayout.blade.php ENDPATH**/ ?>