...
var q=encodeURI($('#searchTop').val());
  ...
  function add_filters()
  {
    ...
    $( ".filter" ).each(function( index ) {
      ...
      if( $(this).is(':checked')  && attributeTitle=="Race"  ){ 
        var value = $(this).val();
        
          options_string_race += value + ",";
    ...
    filter_string += "&options_race=" + options_string_race.slice(0,-1);
