                  ...
                  <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="accordion-item">
                      ...
                      <div id="flush-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="flush-headingTwo">
                       ...
                       <?php $__currentLoopData = $attributesResults['race']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeValues): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check">
                                <input class="form-check-input filter" data-filter_column="Race" type="checkbox" value="<?php echo e($attributeValues->id); ?>" <?php if( isset( $options_race ) and $options_race == $attributeValues->id ) echo 'checked'; ?> id="options_<?php echo e($attributeValues->id); ?>" data-belongs_to_attribute="Race">
                                <label class="form-check-label" for="options_<?php echo e($attributeValues->id); ?>">
                                   <?php echo e($attributeValues->title); ?> <span>(<?php if(isset( $attributeValues->race_ads_count)): ?>
                                      <?php echo e($attributeValues->race_ads_count); ?>
...
<?php endif; ?>
                  ...
                  <div class="col d-flex justify-content-end">
                   <div class="mb-3 pt-2 w-50">
                                <select class="form-select mb-3" aria-label=".form-select-lg example" name="dropsort" id="dropsort">
                                  ...
                                  <option value="datedesc"><?php echo e(__('Latest First')); ?></option>
                                  <option value="dateasc"><?php echo e(__('Oldest First')); ?></option>
                ...
                <div class="row mb-4">
                  <div class="col" id="ftag">
                      ...
                      <a href="javascript:void(0);" id="clearall"><?php echo e(__('clear all')); ?></a>
                  </div>
                </div>
                
                <?php echo $__env->make('front.layout.components.adListBridge', [ 'result' => $result, 'topAdsArray' => $topAdsArray] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
                  ...
                  <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="accordion-item mb-4">
                      ...
                      <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo">
                       ...
                       <?php $__currentLoopData = $attributesResults['race']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attributeValues): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check">
                                <input class="form-check-input filter" data-filter_column="Race" type="checkbox" value="<?php echo e($attributeValues->id); ?>" id="options_<?php echo e($attributeValues->id); ?>" data-belongs_to_attribute="Race">
                                <label class="form-check-label" for="options_<?php echo e($attributeValues->id); ?>">
                                   <?php echo e($attributeValues->title); ?> <span>(<?php if(isset( $attributesResults->race_ads_count)): ?>
                                      <?php echo e($attributesResults->race_ads_count); ?>
...
<script src="<?php echo e(asset( $publicPath . 'front_assets/js/adlistfilters.js')); ?>"></script>

<script type="text/javascript">
  $(document).ready(function() {

  adListSearchFilter().init("<?php echo e(route('search_adlistings')); ?>?kindId=<?php echo e($kindId); ?>&");
});
...
<?php echo $__env->make('front/layout/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dierenlara/domains/dieren-plaats.nl/public_html/resources/views/front/ad/list.blade.php ENDPATH**/ ?>