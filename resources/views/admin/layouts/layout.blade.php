...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/admin/dashboard')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">{{ config('app.name', 'DIEREN PLAATS') }}</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="{{url('/admin/listsubscription')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{url('/admin/listexpectedads')}}" class="nav-link">
