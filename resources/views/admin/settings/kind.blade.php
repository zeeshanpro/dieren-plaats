...
#loader {
  ...
  bottom: 0;
  width: 100%;
  background: rgba(0,125,255,0.5) url("{{asset('admin_assets/dist/img/nTw.gif')}}") no-repeat center center;
  z-index: 10000;
}
.content
{
        ...
        <div class="card-body">
                <table class="table table-head-fixed table-striped" >
                  <thead>
                   ...
                   @include('admin.settings.kind_table_data')
...
<script src="{{asset('admin_assets/dist/js/adskind.js')}}"></script>
