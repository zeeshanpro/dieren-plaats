                ...
                <div class="background"
                    ...
                    <div class="subscribe">
                        <div class="subscribe-title text-center">
                            ...
                            <h1 class="intro-title1st">Find the right used/new marine equipment for your need <br>
                                and view thousands of listings worldwide.</h1>
                        </div>
                        <form action="#">
                            <div class="input-group">
                                <input type="email" placeholder="Search assets " aria-label="Email Adress" required="">
                                <div class="input-group-append">
                                    <button class="btn-custom-round" type="submit"><i class="icon-search"></i></button>
                                </div><!-- .End .input-group-append -->
                            </div><!-- .End .input-group -->

                        </form>
                        <center><a href="#" class="btn btn-primary btn-round mt-3 custom-submit-btn"><span>Sell
    ...
    <div class="container for-you">
                <div>
                    <div class="heading-left">
                        <h2 class="title text-center mb-3">New Products </h2><!-- End .title text-center mb-2 -->
            ...
            <div class="container text-section mt-5 mb-5">
