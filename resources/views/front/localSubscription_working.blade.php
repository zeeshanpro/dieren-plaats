      ...
      <div class="col-md-6 col-md-offset-3">
        ...
        <div class="panel panel-default credit-card-box">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['url' => route('order-subscription_local'), 'data-parsley-validate', 'id' => 'payment-form']) !!}
                    ...
                    <div class="form-group" id="product-group">
                        ...
                        {!! Form::select('plane', ['price_1JxxPNCaEIG4B93yTxn1GsRe' => 'Breeders Plan (€4.95)','price_1JxxQeCaEIG4B93yXx7Be3mO' => 'Animal shelters plan (€1.00)'], null, [
