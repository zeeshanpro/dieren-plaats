...
.form-signin input[type="password"] {
  ...
  <title><?php echo e(config('app.name', 'DIEREN PLAATS')); ?> | Admin Panel</title>
...
<body class="text-center" onload="clearkeys()">
        ...
        <form class="form-signin border rounded" action="<?php echo e(url('/admin/check-admin')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <img style="border-radius: 2.5rem;" class="mb-4 login-logo" src="<?php echo e(asset( $publicPath . 'admin_assets/logo.png')); ?>" alt="Logo File" >
...
<!-- AdminLTE App -->
<script src="<?php echo e(asset( $publicPath . 'admin_assets/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')); ?>"></script>
<script src="<?php echo e(asset( $publicPath . 'admin_assets/dist/js/adminlte.min.js')); ?>"></script>
<!-- AdminLTE for demo purposes -->

    </body>
    </html><?php /**PATH /home/dierenlara/domains/dieren-plaats.nl/public_html/resources/views/admin/login.blade.php ENDPATH**/ ?>