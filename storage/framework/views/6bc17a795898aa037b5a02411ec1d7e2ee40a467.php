            		...
            		<div class="form-box">
            			<div class="form-tab">
	            			<ul class="nav nav-pills nav-fill" role="tablist">
							    <li class="nav-item">
                                    <img src="<?php echo e(URL::to('public/assets/images/email-verification.png')); ?>" alt="email-verification">
                    <span class="nav-link">Email verification</span>
                            ...
                            <div class="text-center">
                                <span>We sent you an email to verify your email</span>
                            </div>
                    ...
                    <div class="container">
                        <div class="row" style="padding-bottom:4%; padding-top:4%;">
							<div class="col-md-3">
                                ...
                                <img src="<?php echo e(URL::to('public/assets/images/demos/demo-21/logo-footer.png')); ?>" class="footer-logo m-auto" alt="Footer Logo" width="100" height="25">
                          </div>
...
<?php /**PATH C:\xampp7.4\htdocs\remora\resources\views/front_new/email_verify.blade.php ENDPATH**/ ?>