            		...
            		<div class="form-box">
            			<div class="form-tab">
	            			<ul class="nav nav-pills nav-fill" role="tablist">
							    <li class="nav-item">
                                    <img src="{{ URL::to('assets/images/email-verification.png') }}" alt="email-verification">
                    ...
                    <div class="container">
                        <div class="row" style="padding-bottom:4%; padding-top:4%;">
							<div class="col-md-3">
                                ...
                                <img src="{{ URL::to('assets/images/demos/demo-21/logo-footer.png') }}" class="footer-logo m-auto" alt="Footer Logo" width="100" height="25">
                          </div>
