                    ...
                    <div class="header-right">
                        ...
                        <div class="wishlist add-product-btn">
                            ...
                            <button type="submit" class="btn btn-outline-primary-2 ">
                                <span class="pr-2"><img src="{{ URL::to('assets/images/icons/add-icon.png') }}"></span> <span class="text-white">Add Product</span>
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                                <img src="{{ URL::to('assets/images/dp.png') }}" alt="dp" width="40px" height="40px">
