                                  ...
                                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                      ...
                                      <li><a class="dropdown-item" href="{{ route('messages') }}">{{__('Messages')}} 
                                         @if($unReadConversations>0)
    <span class="badge badge-primary text-danger" style="background: beige;">{{$unReadConversations}} {{__('New')}}</span>
                                        @endif
        ...
        <div class="container">
            <div class="row">
              <div class="col-md-12">
                  ...
                  <h3>Thank you for paying to promote <a href="{{route('ad_detail_page_slug', [ 'adId' => $adId, 'title' => Str::slug($adTitle), 'kind' => Str::slug($kind) ] )}}">{{$adTitle}}</a></h3>
